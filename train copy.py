...
#patterns = [[(0,0),(0,1),(0,2),(1,0),(1,1),(1,2)],[(0,0),(0,1),(1,0),(1,1),(2,0),(2,1)],[(0,0),(1,0),(2,0),(3,0),(0,1),(1,1)]]
...
final_scores,stage_next_board = td_learning(env, approximator_stage1, num_episodes=50000, alpha=0.15, gamma=0.98,stage="stage1")
